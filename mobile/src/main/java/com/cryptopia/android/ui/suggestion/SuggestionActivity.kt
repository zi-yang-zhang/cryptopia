 ...
 */
class SuggestionActivity : DaggerAppCompatActivity(), AppBarLayout.OnOffsetChangedListener, AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    lateinit var refreshAction: Disposable
